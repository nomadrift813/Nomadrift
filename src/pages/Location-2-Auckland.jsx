...
const Location2 = () => {
  ...
  // ===== 圖片來源陣列（城市相簿） =====
  const images = [
    "./img-Home/location-1.jpg",
    "./img-Location/auckland-5.jpg",
    "./img-Location/auckland-3.jpg",
    "./img-Location/auckland-4.jpg",
  ];
  ...
  return (
    <main>
      ...
      <section id='disDes'>
        ...
        <p className='theCity'>大洋洲-紐西蘭-奧克蘭</p>
      </section>
        ...
        <div className='allContent'>
            ...
            <div className='locTitle'>
              ...
              <FavBtn
                ...
                payload={{
                  ...
                  img: images[0],
                  text:
                    '奧克蘭（Auckland）雖然是紐西蘭的經濟中心，但其生活節奏卻能巧妙地平衡都會的便利與海濱的閒適。這座被譽為「帆船之都」的城市，規模適中，擁有令人稱羨的自然環境與世界級的基礎設施。走在市中心的中央商務區，你將會看到現代化的co-working 空間和企業總部，展現其作為南半球創新與商業樞紐的活力；然而，轉個彎來到海港邊或德文波特（Devonport）等特色社區，映入眼簾的又是充滿咖啡香、設計師小店與遊艇碼頭的悠然景致，是追求高品質生活的數位遊牧者與遠距工作者的理想根據地。氣候屬於溫和的海洋性氣候，四季分明，尤其在夏末**（1月至3月），陽光充足且氣溫舒適，非常適合長時間保持高效率工作。',
                  wifi: WIFI,
                  stars: [1, 1, 1, 2, 2],
                  price: 'NT $15000 /月',
                }}
          ...
          <div className='locScore'>
            <ul>
              ...
              <li><p>消費水平</p><img src="./img-Location/level-2.svg" alt="" /></li>
            ...
            <ul>
              ...
              <li><p>食物品質</p><img src="./img-Location/level-5.svg" alt="" /></li>
