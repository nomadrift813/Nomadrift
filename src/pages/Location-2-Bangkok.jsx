  ...
  return (
    <main>
      ...
      <section id='disDes'>
        ...
        <p className='theCity'>亞洲-泰國-曼谷</p>
      </section>
        ...
        <div className='allContent'>
            ...
            <div className='locTitle'>
              ...
              <FavBtn
                ...
                payload={{
                  ...
                  img: images[0],
                  text:
                    '曼谷（Bangkok）相較於亞洲其他國際大都會，其生活充滿熱情與彈性，是名副其實的「天使之城」。這座城市規模龐大，然而高效的捷運和地鐵系統讓主要生活區域緊密相連，應有盡有。在昭披耶河（Chao Phraya River）畔，你可以見證金碧輝煌的佛寺和古老的市場，感受濃厚的歷史氣息；而轉身踏入素坤逸（Sukhumvit）或通羅（Thonglor）一帶，立刻搖身一變為國際化的熱點，充滿了設計精良的Co-working Space、時尚的精品咖啡館、以及由全球美食家追捧的餐廳。這股融合了效率與異國情調的氛圍，使其成為全球數位遊牧者最熱門的根據地之一。天氣全年溫暖，最舒適的涼季（11月至2月），氣候乾燥宜人，是進行長時工作與深度體驗的最佳時節。',
                  wifi: WIFI,
                  stars: [1, 1, 1, 2, 2],
                  price: 'NT $15000 /月',
                }}
          ...
          <div className='locScore'>
            ...
            <ul>
              ...
              <li><p>醫療品質</p><img src="./img-Location/level-1.svg" alt="" /></li>
            </ul>
          </div>
