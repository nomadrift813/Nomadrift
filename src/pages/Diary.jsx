...
const initialPosts = [
  ...
  },
  {
    ...
    title: '登山挑戰成功！',
    content:
      '和朋友約好挑戰這座海拔兩千公尺的高山，從日出前就開始我們的旅程。一路上，我們氣喘吁吁，雙腿像是灌了鉛，但彼此的鼓勵讓我們沒有停下腳步。山徑蜿蜒，時而穿越濃密的森林，時而踏過濕滑的岩石，每一滴汗水都充滿了努力的證明。當我們終於攀上山頂，太陽正緩緩升起，金色的光芒灑滿整個山谷。雲海在腳下翻騰，遠方的山巒像一幅水墨畫，壯麗得讓人屏息。雖然身體疲憊到了極點，但心靈卻得到了前所未有的洗滌。我們相視而笑，笑聲在山頂迴盪，這一刻，所有的辛苦都化為值得。這片風景不僅僅是眼睛所見，更是心靈深處的震撼與滿足。',
  ...
  },
  {
    ...
    title: '🎉 參加當地節慶',
    content:
      '在這充滿異國情調的城市裡，我有幸參與了一場當地的傳統節慶。從一踏入會場，我就被那股濃厚的文化氛圍深深吸引。空氣中瀰漫著食物的香氣，耳邊傳來獨特的傳統樂曲，眼前是人們身著華麗服飾，隨著音樂翩翩起舞。我穿梭在熱鬧的人群中，品嚐了各種特別的美食，那些口味是我從未體驗過的，每一口都像是一場新的冒險。我跟著當地人學著跳舞，雖然動作笨拙，但每個人都對我報以友善的微笑。這次的體驗，不僅讓我品嚐到美食，更讓我感受到了文化的力量，那種透過節慶傳遞的熱情與團結。離開時，我手中拿著一個小小的傳統工藝品，心中滿載著難忘的回憶。這次的節慶，讓我更深入地了解了這個地方，也讓我對這個世界充滿了更多的好奇心。',
  ...
  },
  {
    ...
    title: '我的第二篇日記',
    content:
      '在這座車水馬龍的城市裡，能認識一個新朋友，總是一件讓人感到溫暖的事情。今天，我在一個共同的興趣小組裡，遇見了小李。我們因為都喜歡老電影而聊了起來，從經典的黑白片到現代的獨立電影，我們的話題彷彿永遠也聊不完。他對電影的獨到見解和幽默的談吐，讓我感到非常投緣。我們聊著聊著，從電影聊到了生活，分享彼此的故事與夢想。那一刻，我感覺自己與這個世界有了更深的連結。原本陌生的人，因為共同的喜好而變得親近。這次的相遇讓我意識到，生活中的每一個轉角，都可能藏著一段新的友誼。能夠與一個新朋友分享喜悅與想法，讓我的今天充滿了意義與溫暖。',
  ...
  },
  {
    ...
    title: '在古巴遇見的色彩與節奏',
    content:
      '在哈瓦那，每個轉角都充滿驚喜。老爺車、雪茄、Salsa舞曲，這裡的一切都像一場熱情的派對。今天，我在一個小巷的藝術工作室裡，遇見了當地的畫家——瑪莉亞。她的畫作充滿了繽紛的色彩與古巴的熱帶風情。我對她的一幅描繪街頭音樂家的畫作深深著迷，我們便從此聊開。她告訴我，每個顏色、每個音符都代表著古巴人的生命力與樂觀。她帶我去了一間她常去的Salsa舞廳，教我跳了幾個簡單的舞步。在音樂與笑聲中，我感受到前所未有的自由與快樂。這次的相遇，不只讓我認識了一個新朋友，更讓我體驗到古巴文化最真實、最有生命力的部分。',
  ...
  },
  {
    ...
    title: '哥斯大黎加的生態奇遇',
    content:
      '哥斯大黎加的雨林，是個充滿生命力的神奇之地。我參加了一個當地的生態導覽，在濃密的樹林裡，導遊胡安帶我們認識了各種奇特的動植物。他對這片土地的熱愛與了解，讓我深受感動。我們聊到了當地人對環境保護的努力，以及他們與大自然和諧共處的生活方式。當我們在雨林深處看到一隻稀有的樹懶時，胡安的眼中閃爍著驕傲與喜悅。他分享的故事，讓我意識到這片雨林不僅是個景點，更是許多人賴以生存的家園。這次的旅程，讓我結識了一位知識淵博又充滿熱情、才華的朋友，也讓我對生態保育有了更深的體會。',
  ...
  },
  {
    ...
    title: '開普敦的色彩與旋律',
    content:
      '在南非的開普敦，我總是被那裡的多元文化所吸引。今天，我在一個當地的市集閒逛時，遇到了一位名叫 Thabo 的街頭藝人。他用非洲鼓演奏著充滿活力的節奏，那鼓聲彷彿在訴說著一個個古老的故事。我駐足聆聽，在他短暫的休息時，我們聊了起來。他分享了許多關於南非音樂與文化的故事，並告訴我，每個鼓點都代表著當地人的情感與生命力。他甚至讓我試著打了幾個節奏，雖然我打得很生疏，但他依然鼓勵我。這次的相遇，讓我更深入地了解了南非文化，也結識了一位充滿熱情與才華的朋友。',
  ...
  },
  {
    ...
    title: '在紐西蘭南島的寧靜相遇',
    content:
      '在紐西蘭南島的湖畔，我找到了內心的平靜。今天，我在一個小鎮的咖啡館裡，遇到了一位名叫 Kahu 的毛利長者。他正悠閒地喝著茶，身旁放著他親手雕刻的木製品。我被其中一個精緻的圖騰雕刻所吸引，便好奇地問他這背後的意義。他微笑著，向我講述了毛利人與自然、祖先之間緊密相連的故事。他的聲音充滿了智慧與溫暖，每個詞都像是在傳遞著古老的力量。我們從雕刻藝術聊到了環保，再聊到紐西蘭人對土地的熱愛。這次的相遇，不只讓我欣賞到了精湛的毛利工藝，更讓我感受到一種深厚的人文精神，也結識了一位充滿智慧的新朋友。',
...
const Diary = () => {
  ...
  // 讀 localStorage 的登入狀態（沿用你全站 nd_auth）
  const raw = localStorage.getItem('nd_auth');
  const authed = raw && JSON.parse(raw)?.isAuthed === true;
  ...
  if (!authed) {
    ...
    // 呼叫全域登入彈窗（MyApp 暴露的）
    if (typeof window.__ndOpenLogin === 'function') {
  ...
  const handlePublishPost = () => {
    ...
    const newPost = {
      ...
      imgSrc: imagePreview,
      location: newPostLocation || '台北/ 台灣',
    ...
    setPosts([newPost, ...posts]);  // 本頁新增
    addMyDiary(newPost);            // 存到 myDiaryStore 給 member-diary 用
    closePostModal();
  ...
  const handleSaveLocal = (postId) => {
    setPosts((prev) =>
      prev.map((p) => (p.id === postId ? { ...p, saved: !p.saved } : p))
    );
  };
  const handleLoadMore = () => setVisibleCount((n) => n + 5);
  ...
  return (
    <main>
      <section className="diaAll">
          ...
          <div className="post-modal-overlay" onClick={closePostModal}>
            ...
            >
              <div className="modal-header">
                <img
                  src="./img-Group/people/People-(11).jpg"
                  alt=""
              ...
              <div className="modal-footer">
                <div className="left-controls">
                  <label htmlFor="file-upload" className="upload-btn">
                    <img src="./img-diary/upphoto.png" alt="上傳照片" />
                    <span>上傳照片</span>
                  </label>
                  <input
                    id="file-upload"
                  ...
                  <div className="location-date">
                    ...
                    <CalendarInput value={newPostDate} onChange={setNewPostDate} />
                  </div>
                </div>
        ...
        {showSuccessModal && (
          <div className="custom-modal-backdrop" style={{ zIndex: 2000 }} onClick={closeSuccessModal}>
            ...
            >
              ...
              <button className="modal-ok-button" onClick={closeSuccessModal}>
                確認
              </button>
            </div>
          </div>
        ...
        {showErrorModal && (
          <div className="custom-modal-backdrop" style={{ zIndex: 3000 }} onClick={closeErrorModal}>
            ...
            >
              ...
              <div className="custom-modal-body">
                <p>{modalMessage || '請先登入會員再操作'}</p>
              </div>
              <button className="modal-ok-button" onClick={closeErrorModal}>
                確認
              </button>
            </div>
          </div>
                          ...
                          <div className="d-sign">
                            ...
                            <div className="allbutton">
                              ...
                              <figure
                                ...
                                onClick={(e) => {
                                  e.preventDefault();
                                  handleSaveLocal(post.id); // 本地 UI 切換；真正收藏由全域委派處理
                                }}
                              >
                                <img
                                  alt="收藏圖示"
        ...
        {/* 背景大圖（你原本的 dia-p1） */}
        <figure className="dia-p1">
          <img src="./img-diary/b-photo.png" alt="" />
        </figure>
      </section>
    </main>
  );
