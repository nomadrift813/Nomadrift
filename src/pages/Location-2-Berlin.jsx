...
const Location2 = () => {
  ...
  // ===== 圖片來源陣列（城市相簿） =====
  const images = [
    "./img-Home/location-6.jpg",
    "./img-Location/Berlin-1.jpg",
    "./img-Location/Berlin-2.jpg",
    "./img-Location/Berlin-3.jpg",
  ];
  ...
  return (
    <main>
      ...
      <section id='disDes'>
        ...
        <p className='theCity'>歐洲-德國-柏林</p>
      </section>
        ...
        <div className='allContent'>
            ...
            <div className='locTitle'>
              ...
              <FavBtn
                ...
                payload={{
                  ...
                  img: images[0],
                  text:
                    '柏林（Berlin）這座城市以其前衛的藝術場景、豐富的歷史底蘊，以及寬鬆的氛圍，成為歐洲最具吸引力的數位遊牧城市之一。這裡的生活節奏，像是一場持續的文化實驗，充滿了無限的可能與靈感。城區規劃廣闊，發達的地鐵、城市快鐵和有軌電車，讓移動既高效又便捷。在城市核心地帶，如米特（Mitte）和克羅伊茨貝格（Kreuzberg），眾多的共同工作空間不僅提供專業設施，更是全球科技新創與自由工作者的社交樞紐。這裡的網路基礎設施在歐洲屬於頂尖水準，為遠距工作提供了堅實的保障。氣候四季分明，夏季（6月至8月）是享受湖泊、公園和露天派對的最佳時節。你可以沉浸在世界知名的博物館、探索冷戰遺跡，或在無數獨立藝廊和地下酒吧中尋找靈感。',
                  wifi: WIFI,
                  stars: [1, 1, 1, 1, 2],
                  price: 'NT $15000 /月',
                }}
          ...
          <div className='locScore'>
            <ul>
              ...
              <li><p>安全性</p><img src="./img-Location/level-4.svg" alt="" /></li>
              <li><p>網路順暢</p><img src="./img-Location/level-3.svg" alt="" /></li>
              <li><p>消費水平</p><img src="./img-Location/level-4.svg" alt="" /></li>
              <li><p>氣候舒適</p><img src="./img-Location/level-2.svg" alt="" /></li>
            </ul>
            <ul>
              <li><p>友善度</p><img src="./img-Location/level-2.svg" alt="" /></li>
              <li><p>語言溝通</p><img src="./img-Location/level-1.svg" alt="" /></li>
              <li><p>交通便利</p><img src="./img-Location/level-3.svg" alt="" /></li>
