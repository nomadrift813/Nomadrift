...
const Location2 = () => {
  ...
  // ===== 圖片來源陣列（城市相簿） =====
  const images = [
    "./img-Home/location-2.jpg",
    "./img-Location/bali-1.jpg",
    "./img-Location/bali-2.jpg",
    "./img-Location/bali-3.jpg",
  ];
  ...
  return (
    <main>
      ...
      <section id='disDes'>
        ...
        <p className='theCity'>亞洲-印尼-峇里島</p>
      </section>
            ...
            <div className='locTitle'>
              ...
              <FavBtn
                ...
                payload={{
                  ...
                  img: images[0],
                  text:
                    '峇里島（Bali）不僅是一個度假勝地，更是一個全球知名的數位遊牧者首都。這裡的生活節奏是獨特的「慢活高效」，可以在享受島嶼寧靜的同時，維持世界級的工作效率。城市不大，但數位基礎設施成熟且集中。在文化中心烏布（Ubud），你可以找到隱藏在綠色稻田間的瑜伽館和健康咖啡館；而長谷（Canggu）一帶，則彙集了大量海景共用工作空間、衝浪學校和時尚的國際社群。這種充滿活力的環境，讓它成為眾多自由接案者的首選地。氣候全年溫暖，是典型的熱帶海島候，無論何時造訪，都能享受陽光與自然。烏魯瓦圖（Uluwatu）衝浪、德格拉朗（Tegallalang）的梯田間騎行，或鄰近的科莫多（Komodo）和龍目島（Lombok）進行跳島旅行。',
                  wifi: WIFI,
                  stars: [1, 1, 2, 2, 2],
                  price: 'NT $15000 /月',
                }}
